...
#if ENABLED(ASSISTED_TRAMMING) // TODO
...
//#define LCD_BACKLIGHT_TIMEOUT_MINS 1  // (minutes) Timeout before turning off the backlight
  ...
  #define PROBE_OFFSET_WIZARD       // Add a Probe Z Offset calibration option to the LCD menu
     ...
     */
    #define PROBE_OFFSET_WIZARD_START_Z -2 // TODO
 ...
 */
//#define LIN_ADVANCE TODO - pri direct drive asi neni potreba
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define FILAMENT_CHANGE_UNLOAD_LENGTH        0  // 100 // (mm) The length of filament for a complete unload.
  ...
  #define ADVANCED_PAUSE_PURGE_FEEDRATE        2  // 3 // (mm/s) Extrude feedrate (after loading). Should be slower than load feedrate.
 ...
 */
   ...
   */
  #define HYBRID_THRESHOLD // !SpreadCycle with higher speeds (3000) makes stepper noise
   ...
   */
  // #define TMC_DEBUG    // ! Generates hearable click sounds on stepper with higher speeds :(

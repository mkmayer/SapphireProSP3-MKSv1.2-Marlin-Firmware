...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  //#define PID_PARAMS_PER_HOTEND // Use separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_Kp_LIST {  10.38,  22.20 }
    #define DEFAULT_Ki_LIST {   0.72,   1.08 }
    #define DEFAULT_Kd_LIST {  37.68, 114.00 }
  #else
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80.3, 80.3, 1600, 428 } // 415
...
#define Z_PROBE_FEEDRATE_FAST (6*100)

// Feedrate (mm/min) for the "accurate" probe of each point
#define Z_PROBE_FEEDRATE_SLOW (2*100)
...
#define MANUAL_Z_HOME_POS 0.4 // Z-MIN switch offset
